...
End Select
ImageComboHandle = CreateWindowEx(dwExStyle, StrPtr("ComboBoxEx32"), NULL_PTR, dwStyle, 0, 0, UserControl.ScaleWidth, UserControl.ScaleHeight, UserControl.hWnd, NULL_PTR, App.hInstance, ByVal 0&)
If ImageComboHandle <> NULL_PTR Then
