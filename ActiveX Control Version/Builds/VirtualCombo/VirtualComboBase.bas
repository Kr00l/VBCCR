...
#If Win64 Then
Private Declare PtrSafe Function SetClassLong Lib "user32" Alias "SetClassLongPtrW" (ByVal hWnd As LongPtr, ByVal nIndex As Long, ByVal dwNewLong As LongPtr) As LongPtr
...
#Else
Private Declare PtrSafe Function SetClassLong Lib "user32" Alias "SetClassLongW" (ByVal hWnd As LongPtr, ByVal nIndex As Long, ByVal dwNewLong As LongPtr) As LongPtr
...
If wMsg = WM_CREATE Then
    ...
    If VcbComboLBoxOrigProcPtr = NULL_PTR Then VcbComboLBoxOrigProcPtr = SetClassLong(hWndClass, GCL_WNDPROC, AddressOf VcbComboLBoxCreateProc)
    ...
    If VcbComboLBoxHandle <> NULL_PTR Then
        If VcbComboLBoxOrigProcPtr <> NULL_PTR Then SetWindowLong VcbComboLBoxHandle, GWL_WNDPROC, VcbComboLBoxOrigProcPtr
        VcbComboLBoxHandle = NULL_PTR
    End If
